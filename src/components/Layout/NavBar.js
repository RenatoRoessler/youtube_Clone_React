import { makeStyles, Hidden, Drawer, Box, List, ListItem, ListItemIcon, ListItemText, ListSubheader, Avatar, Divider, Typography, Button } from '@material-ui/core'
        ...
        {primaryMenu.map((item) => {
          ...
          return (
            <ListItem key={item.id} button classes={{ root: classes.listItem }} selected={isSelected(item)} >
              ...
              <ListItemText classes={{ primary: classes.listItemText }} primary={item.label}></ListItemText>
            </ListItem>
          )
        })}
      </List>
